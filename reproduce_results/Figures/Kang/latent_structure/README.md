...
`umap-learn`, `numba`, `pynndescent`, and `llvmlite`. Different builds can shift the embedding even with fixed seed. To reproduce exactly, add the code below to the first cell of `3) Visualize genes and latent.ipynb` notebook.
