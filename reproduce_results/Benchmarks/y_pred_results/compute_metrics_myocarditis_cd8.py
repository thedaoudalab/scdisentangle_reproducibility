...
def compute_metrics(
    ...
    adata_org = adata_org[adata_org.obs['cell_type'] == 'CD8'].copy()
    ...
    for ood_cov in tqdm(ood_covs):
        ...
        for seed_nb in seed_list:
            for method_name in methods:
                ...
                adata_pred = adata_pred[adata_pred.obs['cell_type'] == 'CD8'].copy()
                ...
                save_path = f"results/{data_name}_CD8/{method_name}"
