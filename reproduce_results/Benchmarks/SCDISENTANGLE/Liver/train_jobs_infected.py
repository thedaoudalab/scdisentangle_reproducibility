...
yaml_path = "configs/liver_infected.yaml"
max_epochs = 521
...
def run_single_job(args):
    ...
    hparams["growing_neurons"]["prior_mappers"]["mappers"]["zone_mapper"][
        "collapse_name"
    ] = ood_cov
    ...
    train_scdisentangle.make_run(
        ...
        seed_nb=seed_nb,
        save_path=f"{job_dir}/",
        split_key=f'split_TRUE_{ood_cov}',
    )
