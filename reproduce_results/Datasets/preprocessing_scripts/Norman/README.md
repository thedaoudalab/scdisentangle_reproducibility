...
**perturbation** category ordering across runs. To reproduce paper numbers exactly, download the exact **`norman.h5ad`: <LINK>**, put in `../../preprocessed_datasets/Norman/` and skip `1) default_pp.ipynb`.
