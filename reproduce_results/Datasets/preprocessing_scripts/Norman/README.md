...
**perturbation** category ordering across runs. To reproduce paper numbers exactly, download the exact **`norman.h5ad`: <[LINK](https://zenodo.org/records/21543559/files/norman.h5ad?download=1)>**, put in `../../preprocessed_datasets/Norman/` and skip `1) default_pp.ipynb`.
